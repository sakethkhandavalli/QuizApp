...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { index: @state.index, score: @state.score, subgenre_id: @state.subgenre_id, user_id: @state.user_id } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { index: @state.index, score: @state.score, subgenre_id: @state.subgenre_id, user_id: @state.user_id } }
